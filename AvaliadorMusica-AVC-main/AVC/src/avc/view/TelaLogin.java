...
public class TelaLogin extends JFrame {
    ...
    private boolean verificarLogin(String usuario, String senha) {
        try {
            BufferedReader br = new BufferedReader(new FileReader("AvaliadorMusica-AVC-main\\AVC\\src\\usuarios.txt"));
            String linha;
    ...
    public TelaLogin() {
        ...
        lblLogo.setIcon(new ImageIcon("AvaliadorMusica-AVC-main\\AVC\\Imagens\\imagem.png"));
        ...
        lblImgUser.setIcon(new ImageIcon("AvaliadorMusica-AVC-main\\AVC\\Imagens\\icons8-usuário-homem-com-círculo-28.png"));
        ...
        lblImgSenha.setIcon(new ImageIcon("AvaliadorMusica-AVC-main\\AVC\\Imagens\\icons8-password-28.png"));
